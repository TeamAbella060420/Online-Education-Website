    ...
    <section class="contact">
      ...
      <div class="box-container">
        <div class="box">
          ...
          <a href="tel:111222333">111222333</a>
        </div>
        <div class="box">
          <i class="fas fa-envelope"></i>
          <h3>Email Address</h3>
          <a href="mailto:teamabella@outlook.com">teamabella@outlook.com</a>
          <a href="mailto:teamabella060420@gmail.com"
            >teamabella060420@gmail.com</a
          >
        </div>
        <div class="box">
          <i class="fas fa-map-marker-alt"></i>
          <h3>Office Address</h3>
          <a href="">123 Adobo St. Sinigang Rd. Kaldereta Ave.</a>
          <a href="">555 Tuna HWY. Sardinas City Gout Bldg.</a>
        </div>
      </div>
    </section>
